 ...
 * Manager and above only â€” checked against the live LuckPerms group, not a
 ...
 * The creator picks per code â€” crate keys, money, or both:
 * <pre>
...
public final class RedeemCodeModule {
    ...
    public boolean admin(CommandSender sender, String[] args) {
        ...
        } else if (!sender.hasPermission("coltcore.redeemcode")) {
        ...
        switch (sub) {
            ...
            default -> {
                ...
                sender.sendMessage(UiKit.colour("&#00ff00Creator codes"));
