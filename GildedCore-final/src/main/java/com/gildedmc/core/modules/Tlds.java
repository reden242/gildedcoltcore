 ...
 *
 * <p>This list is for the case with no dot to anchor on: {@code play gildedmc
 * pro} on three lines of a sign, or {@code playgildedmcpro} run together. There
 ...
 * {@code co.uk} and {@code com.br} are carried as well, so {@code play gildedmc
