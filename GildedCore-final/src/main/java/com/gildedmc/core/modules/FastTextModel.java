...
public final class FastTextModel {
     ...
     * <pre>
     *   java -cp target/classes com.gildedmc.core.modules.FastTextModel \
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.printf("come to p l a y dot gildedmc dot net -> %.3f%n",
                model.advertisingProbability("come to p l a y dot gildedmc dot net"));
