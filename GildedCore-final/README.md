...
Build: `mvn clean package` → `target/GildedCore-1.13.0.jar`. Java 21, Paper 1.21.4.
...
makes GildedCore GPLv3, meaning you must publish your full source to anyone you
